// LEG-1 (#427): публичная страница пользовательского соглашения.
// Полный близнец PrivacyPage — тот же /legal/{doc_id} контур,
// doc_id=terms (редактируется в консоли: Документы → Пользовательское
// соглашение).
